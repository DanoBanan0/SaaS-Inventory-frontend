...
import { useEffect, useState, useCallback, useRef } from "react"; // 1. Agregado useRef
...
export default function CategoryDetailPage() {
    ...
    // 3. Crear la referencia para la tabla (Esto permite imprimirla)
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    {/* 4. AQUÍ AGREGAMOS EL COMPONENTE DE ACCIONES (IMPRIMIR / EXCEL) */}
                    <InventoryTableActions
                        tableRef={tableRef}
                        data={devices} // Le pasamos los datos actuales para el Excel
            ...
            <Card>
                <CardContent className="p-0 overflow-x-auto">
                    {/* 5. AGREGAMOS EL ref={tableRef} A UN DIV QUE ENVUELVE LA TABLA */}
                    <div ref={tableRef}>
                        <Table>
                            <TableHeader className="bg-slate-100">
                                <TableRow>
                                    ...
                                    {/* Agregamos una clase para ocultar esta columna al imprimir */}
                                ...
                                {loading ? (
                                    ...
                                    devices.map((device) => (
                                        <TableRow key={device.id} className="hover:bg-slate-50/80 transition-colors">
                                            ...
                                            {/* Ocultamos esta celda al imprimir con print:hidden */}
