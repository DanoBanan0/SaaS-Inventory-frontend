        ...
        <div className="space-y-6">
            ...
            <Card>
                <CardContent className="p-0 overflow-x-auto">
                    ...
                    {/* --- CAMBIO: FOOTER DE PAGINACIÓN --- */}
                    <div className="flex items-center justify-end p-4 border-t border-slate-100 bg-slate-50/30 gap-2">
                        <div className="flex items-center gap-1 mr-4">
                            <span className="text-xs text-slate-500">
                                Mostrando {pagination.from}-{pagination.to} de {pagination.total} | Página <span className="font-medium text-slate-900">{pagination.current_page}</span> de <span className="font-medium text-slate-900">{pagination.last_page}</span>
                            </span>
                        </div>
