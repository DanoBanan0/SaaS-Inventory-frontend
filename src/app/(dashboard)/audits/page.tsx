    ...
    return (
        <div className="space-y-6 p-6 max-w-[1600px] mx-auto">
            ...
            <Card className="shadow-sm border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 overflow-hidden">
                ...
                <div className="flex items-center justify-between sm:justify-end p-4 border-t border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 gap-2">
