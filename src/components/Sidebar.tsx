    ...
    return (
        <aside className={cn("bg-slate-900 text-slate-300 border-r border-slate-800 flex flex-col h-full", className)}>
            ...
            <div className="p-4 border-t border-slate-800 bg-slate-950/30 flex items-center justify-between">
                <button onClick={handleLogout} className="flex items-center gap-3 px-3 py-2.5 rounded-md text-sm font-medium text-red-400 hover:bg-red-950/30 transition-colors">
